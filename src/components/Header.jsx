...
const Header = ()=>{
    ...
    return(
        <div className="flex justify-between items-center px-6 md:px-8 py-2 shadow bg-black text-white ">
            <Link to="/">
                <img className="h-12" data-testid='logo' src="https://th.bing.com/th/id/R.f6bc2b2712b5a390fee444e60d312b69?rik=qTqjtW7Nn4UiJw&riu=http%3a%2f%2fwww.gadgetsmagazine.com.ph%2fwp-content%2fuploads%2f2017%2f09%2ffoodpanda-logo.png&ehk=Jy3z435XdWQADxTy4KoiuJvyN6HyGj9DOZIzHuitbEI%3d&risl=&pid=ImgRaw&r=0" alt="" />
            </Link>
